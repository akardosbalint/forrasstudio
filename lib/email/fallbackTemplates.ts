...
> = {
  hu: {
    questionnaire_invite: {
      subject: "MI Építettük — rendszertervezési kérdőív",
      bodyHtml:
        "<p>Kedves {{leadName}}!</p>" +
        ...
        "<p>Üdvözlettel,<br />MI Építettük</p>",
      bodyText:
        "Kedves {{leadName}}!\n\n" +
  ...
  en: {
    questionnaire_invite: {
      subject: "MI Építettük — system design questionnaire",
      bodyHtml:
        "<p>Dear {{leadName}},</p>" +
        ...
        "<p>Best regards,<br />MI Építettük</p>",
      bodyText:
        "Dear {{leadName}},\n\n" +
