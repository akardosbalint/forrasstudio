...
export function CaseStudyCard({ href, index, children }: CaseStudyCardProps) {
  ...
  return (
    <motion.a
      ...
      className="glow-card group relative flex h-full flex-col overflow-hidden rounded-2xl border border-paper-3 bg-white/60 p-6 [--glow-color:var(--color-spring)] hover:-translate-y-1.5 hover:border-spring/60 hover:bg-white/90 sm:p-7"
    >
