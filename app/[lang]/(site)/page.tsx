...
export default async function Home({
  ...
  return (
    <>
      <Nav lang={lang} dict={dict.site.nav} languageSwitcherLabels={dict.common.languageSwitcher} />
      <main className="flex-1">
        <Hero
          lang={lang}
          dict={dict.site.hero}
          callbackFormDict={dict.site.callbackForm}
        ...
        <FinalCTA lang={lang} dict={dict.site.finalCta} callbackFormDict={dict.site.callbackForm} />
      </main>
      <Footer
        lang={lang}
